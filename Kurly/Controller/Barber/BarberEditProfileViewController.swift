//
//  BarberEditProfileViewController.swift
//  Kurly
//
...
class BarberEditProfileViewController: UIViewController {
    ...
    func navigateToBarberView() {
        if let viewController = navigationController?.viewControllers.first(where: {$0 is BarberViewController}) {
